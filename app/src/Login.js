                                        ...
                                        <form className="row g-3 needs-validation" action="/dashboard">
                                            <div className="col-12">
                                                ...
                                                <div className="input-group has-validation">
                                                    <input type="email" name="email" className="form-control" id="eamil" placeholder="Enter your email 
                                                     address" required />
                                            ...
                                            <div className="col-12">
                                                ...
                                                <input type="password" name="password" className="form-control" id="yourPassword" placeholder="Enter 
